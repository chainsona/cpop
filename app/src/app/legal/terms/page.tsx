...
export default function TermsOfService() {
  ...
  return (
    <>
      ...
      <p className="mb-4">
        Welcome to POAP Platform. These Terms of Service govern your use of our website and services.
      ...
      <p className="mb-4">
        <strong>POAP:</strong> Proof of Attendance Protocol, which is a digital collectible that represents proof of participation in an event.
      </p>
      <p className="mb-4">
        <strong>Platform:</strong> The websites, applications, and services provided by POAP Platform.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        The Platform and its content, features, and functionality are owned by POAP Platform and are protected by copyright,
      ...
      <p className="mb-4">
        In no event shall POAP Platform be liable for any indirect, incidental, special, consequential, or punitive damages,
