...
import { ArrowLeft, Globe, User, Building, PlusCircle, Trash, Save, Loader2 } from 'lucide-react';
  ...
  const handleSave = async () => {
    try {
      ...
      const attributesData = {
        ...
        platform: eventLocation === 'online' 
          ? (platform === 'other' ? customPlatform : platform) 
          : null,
        platformUrl: eventLocation === 'online' && platformUrl ? 
        ...
        if (response.status === 404 && method === 'PATCH' && 
          ...
          try {
            ...
            try {
              ...
              throw new Error(`Server returned invalid JSON on retry: ${retryResponseText.substring(0, 100)}...`);
            }
            
            if (!retryResponse.ok) {
              throw new Error(retryResponseData.error || retryResponseData.message || 
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl font-bold mb-6">POAP Attributes</h2>
