...
export interface POAPTokenProps {
  id: string;
  title: string;
  description: string;
  imageUrl: string;
          ...
          <div className="flex items-center justify-between">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <div>
                    <p className="font-medium">POAP Token</p>
                    <p className="text-xs text-neutral-500">
                      {isCompressed ? 'Compressed Token2022 POAP' : 'Standard POAP token'}
                    </p>
                  </div>
                </TooltipContent>
              </Tooltip>
