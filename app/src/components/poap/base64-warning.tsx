    ...
    <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-md text-yellow-800 flex items-start gap-3">
      ...
      <div>
        ...
        <p className="text-xs mt-1">
          {count} POAP{count > 1 ? 's' : ''}{' '}
          {count > 1 ? 'are' : 'is'} using base64 encoded images, which may affect
          performance. Consider uploading images to a dedicated storage service for better
          performance.
        </p>
      </div>
    </div>
