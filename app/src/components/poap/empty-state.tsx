...
export function EmptyState({ 
  message = "You haven't created any POAPs yet",
  showButton = true,
  buttonText = "Create your first POAP",
  buttonUrl = "/poaps/create",
  buttonAction,
  ...
  return (
    <div className="flex flex-col items-center justify-center p-10 text-center bg-neutral-50 rounded-lg border border-neutral-200">
      ...
      <h3 className="text-xl font-medium mb-2">No POAPs found</h3>
