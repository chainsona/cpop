...
import { getSafeImageUrl } from '@/lib/poap-utils';

interface POAPImageDisplayProps {
  id: string;
  imageUrl: string;
  title: string;
  className?: string;
...
/**
 * Component for displaying a POAP image with consistent styling
 * based on the POAP ID
 */
export function POAPImageDisplay({ id, imageUrl, title, className }: POAPImageDisplayProps) {
