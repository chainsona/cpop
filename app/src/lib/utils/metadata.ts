...
const APP_NAME = 'POAP';
const DEFAULT_DESCRIPTION = 'Manage Proof of Attendance Protocol tokens for your events';
const BASE_URL = process.env.NEXT_PUBLIC_APP_URL || 'https://ngrok.maikers.com'; // Update with actual production URL
...
export function generateMetadata(
  ...
  try {
    ...
    metadataBaseUrl = new URL('https://ngrok.maikers.com');
  }
