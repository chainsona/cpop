...
export function POPInfoDisplay({
  pop,
  organization,
  artists,
  metadataOutdated,
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <div className="text-sm font-medium text-neutral-500 mb-1">POP ID</div>
          <div className="font-mono text-sm">{pop.id}</div>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <div>{formatDateRange(new Date(pop.startDate), new Date(pop.endDate))}</div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {pop.token?.mintAddress}
              </Link>
              <Button
                variant="ghost"
                size="sm"
                className="p-1 h-auto"
                onClick={() => copyToClipboard(pop.token?.mintAddress || '')}
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    `https://explorer.solana.com/address/${pop.token?.mintAddress}?cluster=${cluster}`,
                    '_blank'
                  )
                }
