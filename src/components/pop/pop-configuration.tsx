...
interface POPConfigurationProps {
  className?: string;
}

export function POPConfiguration({ className }: POPConfigurationProps) {
  // Distribution state
  ...
  return (
    ...
    >
      <h2 className="text-xl font-bold mb-6 text-neutral-900">POP Configuration</h2>
