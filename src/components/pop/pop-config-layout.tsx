...
interface POPConfigLayoutProps {
  popId: string;
...
export function POPConfigLayout({
  popId,
  distributionStatus,
  distributionSummary,
  tokenStatus,
  ...
  return (
    <div className={cn('relative', className)}>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold">POP Configuration</h2>
