 ...
 */
export function AddMethodDialog({ popId, onClose, onMethodAdded }: AddMethodDialogProps) {
  return (
        ...
        <div className="py-4">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="border border-neutral-200 hover:border-blue-300 rounded-lg p-4 cursor-pointer transition-colors">
              ...
              <div className="mt-3">
                <Link href={`/pops/${popId}/distribution/new?type=links`} passHref>
            ...
            <div className="border border-neutral-200 hover:border-emerald-300 rounded-lg p-4 cursor-pointer transition-colors">
              ...
              <div className="mt-3">
                <Link href={`/pops/${popId}/distribution/new?type=secret`} passHref>
                  <Button size="sm" variant="outline" className="w-full">
                    Select
                  </Button>
                </Link>
            ...
            <div className="border border-neutral-200 hover:border-orange-300 rounded-lg p-4 cursor-pointer transition-colors">
              ...
              <div className="mt-3">
                <Link href={`/pops/${popId}/distribution/new?type=location`} passHref>
                  <Button size="sm" variant="outline" className="w-full">
                    Select
                  </Button>
                </Link>
            ...
            <div className="border border-neutral-200 hover:border-purple-300 rounded-lg p-4 cursor-pointer transition-colors">
              ...
              <div className="mt-3">
                <Link href={`/pops/${popId}/distribution/new?type=airdrop`} passHref>
                  <Button size="sm" variant="outline" className="w-full">
                    Select
                  </Button>
                </Link>
