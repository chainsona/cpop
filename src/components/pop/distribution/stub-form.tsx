...
export function ClaimLinksForm({ id }: { id: string }) {
  return (
    <StubForm
      ...
      description="Generate unique links that can be distributed to recipients to claim the POP."
    />
  );
}
...
export function SecretWordForm({ id }: { id: string }) {
  return (
    <StubForm
      ...
      description="Create a secret word that recipients must enter to claim the POP."
    />
  );
}
...
export function LocationBasedForm({ id }: { id: string }) {
  return (
    <StubForm
      ...
      description="Set up location-based claiming for your POP."
    />
  );
}
