...
import { getClaimUrl } from '@/components/pop/distribution/utils';
import { MethodInfoCard } from '@/components/pop/distribution/method-info-card';
import { ClaimLinkTable } from '@/components/pop/distribution/claim-link-table';
import { QRCodeModal } from '@/components/pop/distribution/qr-code-modal';
import { AirdropCostAnalysis } from '@/components/pop/distribution/airdrop-cost-analysis';
import { AirdropAddressesList } from '@/components/pop/distribution/airdrop-addresses-list';
import { DeleteMethodDialog } from '@/components/pop/distribution/delete-method-dialog';

export default function DistributionMethodDetailsPage() {
  const pathname = usePathname();
  const pathSegments = pathname.split('/');
  const id = pathSegments[2]; // Extract ID from URL path: /pops/[id]/distribution/[methodId]
  ...
  const deleteMethod = async () => {
    ...
    try {
      ...
      window.location.href = `/pops/${id}/distribution`;
    } catch (err) {
